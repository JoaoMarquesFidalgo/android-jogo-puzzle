...
if (isset($_GET['pontuacao']) && isset($_GET['tempo'])&& isset($_GET['pontuacao_desaf_3'])&& isset($_GET['nome'])) {
    $pontuacao = $_GET['pontuacao'];
    $tempo = $_GET['tempo'];
    $pontuacao_desaf_3 = $_GET['pontuacao_desaf_3'];
    $nome = $_GET['nome'];
    ...
    $query = "UPDATE pontuacao SET pontuacao=?,tempo=?,pontuacao_desaf_3=? WHERE id=?";
        $sth = $conn->prepare($query);
