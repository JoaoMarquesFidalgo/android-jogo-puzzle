...
if (isset($_GET['pontuacao']) && isset($_GET['tempo'])&& isset($_GET['pontuacao_desaf_1'])&& isset($_GET['nome'])) {
    $pontuacao = $_GET['pontuacao'];
    $tempo = $_GET['tempo'];
    $pontuacao_desaf_1 = $_GET['pontuacao_desaf_1'];
    $nome = $_GET['nome'];
    ...
    $query = "UPDATE pontuacao SET pontuacao=?,tempo=?,pontuacao_desaf_1=? WHERE id=?";
        $sth = $conn->prepare($query);
        $sth->bindParam(1, $pontuacao);
        $sth->bindParam(2, $tempo);
        $sth->bindParam(3, $pontuacao_desaf_1);
